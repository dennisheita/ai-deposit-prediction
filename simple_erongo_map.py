#!/usr/bin/env python3
"""
Create a simple Erongo map with just the largest prediction file.
"""
...
def create_simple_erongo_map():
    """Create a simple map using the largest prediction file."""
    
    print("Creating simple Erongo map...")
    ...
    if largest_file:
        print(f"Using largest file: {largest_file} ({max_size} points)")
        ...
        try:
            ...
            # Save map
            m.save('simple_erongo_map.html')
            print("Simple map saved to: simple_erongo_map.html")
